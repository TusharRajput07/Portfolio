...
const Home = () => {
  return (
    <div className="flex px-36 pt-10 bg-[#f0f0f0] dark:bg-[#101826]">
      {/* left container */}
      ...
      <div className="flex pt-24 text-gray-500 w-full">
        ...
        <div className="w-1/2 dark:text-gray-300 pl-10">
          <div className="text-[#404040] leading-normal mb-5 text-5xl font-extrabold dark:bg-gradient-to-r  dark:from-[#56B4AC] dark:to-[#a34b74] dark:text-transparent dark:bg-clip-text dark:animate-gradient">
            Tushar Rajput
          </div>
          ...
          <div className="text-base  flex items-center bg-[#404040]  w-fit rounded-lg text-white my-10 cursor-pointer hover:shadow-lg dark:bg-gradient-to-r  dark:from-[#56B4AC] dark:to-[#7728a4] dark:text-white dark:animate-gradient">
